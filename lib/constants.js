...
module.exports = exports = {
  ...
  formatContextFlags: {
    GENPTS: binding.AVFMT_FLAG_GENPTS,
    IGNIDX: binding.AVFMT_FLAG_IGNIDX,
    NONBLOCK: binding.AVFMT_FLAG_NONBLOCK,
    IGNDTS: binding.AVFMT_FLAG_IGNDTS,
    NOFILLIN: binding.AVFMT_FLAG_NOFILLIN,
    NOPARSE: binding.AVFMT_FLAG_NOPARSE,
    NOBUFFER: binding.AVFMT_FLAG_NOBUFFER,
    CUSTOM_IO: binding.AVFMT_FLAG_CUSTOM_IO,
    DISCARD_CORRUPT: binding.AVFMT_FLAG_DISCARD_CORRUPT,
    FLUSH_PACKETS: binding.AVFMT_FLAG_FLUSH_PACKETS,
    BITEXACT: binding.AVFMT_FLAG_BITEXACT,
    SORT_DTS: binding.AVFMT_FLAG_SORT_DTS,
    FAST_SEEK: binding.AVFMT_FLAG_FAST_SEEK,
    AUTO_BSF: binding.AVFMT_FLAG_AUTO_BSF
  },
  avoidNegativeTs: {
    AUTO: binding.AVFMT_AVOID_NEG_TS_AUTO,
    DISABLED: binding.AVFMT_AVOID_NEG_TS_DISABLED,
    MAKE_NON_NEGATIVE: binding.AVFMT_AVOID_NEG_TS_MAKE_NON_NEGATIVE,
    MAKE_ZERO: binding.AVFMT_AVOID_NEG_TS_MAKE_ZERO
  },
  seek: {
